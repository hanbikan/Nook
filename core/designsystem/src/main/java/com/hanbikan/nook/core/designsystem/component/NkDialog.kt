...
fun NkDialog(
    ...
    NkDialogWithContents(visible, onDismissRequest, onConfirmation, confirmText, hasOnlyConfirmationButton) {
        if (imageUrl != null) {
            AsyncImage(
                model = imageUrl,
...
fun NkDialogWithContents(
    ...
    NkDialogBase(visible, onDismissRequest) {
        Column(
            modifier = Modifier
                .padding(Dimens.SpacingMedium, Dimens.SpacingMedium, Dimens.SpacingMedium, 0.dp),
...
fun NkFullDialog(
    ...
    FadeAnimatedVisibility(visible = visible) {
        ...
        // Container that mimics dialog behavior
        Box(
            modifier = Modifier
                .fillMaxSize()
            ...
            Column(
                modifier = Modifier
                    .background(NkTheme.colorScheme.background, shape = RoundedCornerShape(16.dp))
                    .padding(16.dp)
                    .clickable(
                        interactionSource = interactionSource,
                        indication = null,
